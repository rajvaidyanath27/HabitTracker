...
function Drawer() {
  ...
  return <AnimatePresence>
			{content && <>
					...
					{createPortal(<motion.div key='drawer' className={styles.drawer} variants={variants} initial='initial' animate='animate' exit='exit' drag='y' dragConstraints={{
        top: 0,
        bottom: 0
      }} dragElastic={{
        top: 0.1,
        bottom: 1
							...
							{content.actions && content.actions.length > 0 && <ul className={styles.actions} onClick={closeDrawer}>
									{content.actions.map(({
            label,
            indicator,
            ...rest
              ...
              style: {
                ...
                ...indicator?.style
							...
							{content.placeholder && <div className={styles.placeholderWrapper}>
