...
function DiaryPage() {
  ...
  return <div className={styles.diary}>
			<NoteList habitId={habitId} onScrollTop={handleScrollToTop} />

			<NoteForm habitId={habitId} streak={currentStreak} />

			<DiaryToolbar showScrollTop={showScrollTop} onScrollTop={handleScrollToTop} />
		</div>;
}
export { DiaryPage };
