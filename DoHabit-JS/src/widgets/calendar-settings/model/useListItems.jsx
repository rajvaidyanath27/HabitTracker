...
function useListItems() {
  ...
  const listItems = [{
    ...
    extra: <Switch isActive={settings.calendarView === 'compact'} onClick={() => settingsDispatch({
      type: 'updateSettings',
      payload: {
    ...
    description: settings.calendarHighlightToday ? 'Today is highlighted' : 'Today is not highlighted',
    extra: <Switch isActive={settings.calendarHighlightToday} onClick={() => settingsDispatch({
      type: 'updateSettings',
      payload: {
    ...
    extra: <Switch isActive={settings.calendarShowDayNames} onClick={() => settingsDispatch({
      type: 'updateSettings',
      payload: {
    ...
    description: 'Applies to the default calendar only',
    extra: <Switch isActive={settings.calendarShowDayNumbers} onClick={() => settingsDispatch({
      type: 'updateSettings',
      payload: {
